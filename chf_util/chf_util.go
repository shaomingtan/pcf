...
// FetchSpendingLimitDecision will find a CHF instance and subscribe PDU session to the CHF as well as return spending limit decision
func FetchSpendingLimitDecision(supi string, gpsi string) (*models.SpendingLimitStatus, *models.ProblemDetails) {
	// Get chf uri
	uri := getCHFUri()
